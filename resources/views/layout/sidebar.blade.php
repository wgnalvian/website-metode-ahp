            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{url('/admin/category/add')}}">Add Category</a>
                 <a class="collapse-item" href="{{url('/admin/category/compar')}}">Compare Category</a>
                      <a class="collapse-item" href="{{url('/admin/category/compar/list')}}">List Comparation Category</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{url('/admin/subcategory')}}">List Sub Category</a>
                <a class="collapse-item" href="{{url('/admin/subcategory/add')}}">Add Sub Category</a>
